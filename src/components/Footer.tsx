...
const Footer = () => {
  return (
    <footer className="bg-Terracotta">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-12">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            ...
            <div className="text-center sm:text-left">
              <p className="text-lg font-medium text-SoftCream">Our Services</p>
            ...
            <div className="text-center sm:text-left">
              <p className="text-lg font-medium text-SoftCream">Contact Us</p>
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      className="size-5 shrink-0 text-SoftCream"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth="2"
        ...
        <div className="mt-12 border-t border-gray-100 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="text-sm text-WarmWhite">
              ...
              <a
                className="inline-block text-SoftCream underline transition hover:text-BurnishedBronze"
                href="#"
              >
                Terms & Conditions
              </a>
